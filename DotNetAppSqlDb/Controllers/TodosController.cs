...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Name1,Name2,Name3,Name4,Name5,Name6,Name7,Description,CreatedDate,Done")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name1,Name2,Name3,Name4,Name5,Name6,Name7,Description,CreatedDate")] Todo todo)
        {
